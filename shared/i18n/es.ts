  ...
  projects: {
    ...
    items: {
      ...
      'travel-landing': {
        ...
        description:
          'Una experiencia cinematográfica de viajes construida con desplazamiento suave y transiciones inmersivas.'
      },
      ...
      'book-store': {
        ...
        title: 'Book Store',
        description:
          'Una tienda de libros enfocada en arquitectura escalable y componentes reutilizables.'
      },
      ...
      'halloween-landing': {
        ...
        description:
          'Una experiencia de Halloween con animaciones avanzadas y efectos 3D en tiempo real.'
      },
